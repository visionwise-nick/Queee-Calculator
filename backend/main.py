...
```json
// 🟢 三角函数（支持度数和弧度）
{"type": "expression", "expression": "sin(x)"}      // 正弦（传统格式）
{"type": "expression", "expression": "Math.sin(x)"}  // 正弦（JavaScript格式）
{"type": "expression", "expression": "cos(x)"}      // 余弦（传统格式）
{"type": "expression", "expression": "Math.cos(x)"}  // 余弦（JavaScript格式）
{"type": "expression", "expression": "tan(x)"}      // 正切（传统格式）
{"type": "expression", "expression": "Math.tan(x)"}  // 正切（JavaScript格式）
{"type": "expression", "expression": "asin(x)"}     // 反正弦（传统格式）
{"type": "expression", "expression": "Math.asin(x)"}  // 反正弦（JavaScript格式）
{"type": "expression", "expression": "acos(x)"}     // 反余弦（传统格式）
{"type": "expression", "expression": "Math.acos(x)"}  // 反余弦（JavaScript格式）
{"type": "expression", "expression": "atan(x)"}     // 反正切（传统格式）
{"type": "expression", "expression": "Math.atan(x)"}  // 反正切（JavaScript格式）

// 🟢 对数和指数函数
{"type": "expression", "expression": "log(x)"}      // 自然对数（传统格式）
{"type": "expression", "expression": "Math.log(x)"}  // 自然对数（JavaScript格式）
{"type": "expression", "expression": "log10(x)"}    // 常用对数（传统格式）
{"type": "expression", "expression": "Math.log10(x)"}  // 常用对数（JavaScript格式）
{"type": "expression", "expression": "log2(x)"}     // 二进制对数（传统格式）
{"type": "expression", "expression": "Math.log2(x)"}  // 二进制对数（JavaScript格式）
{"type": "expression", "expression": "exp(x)"}      // e^x（传统格式）
{"type": "expression", "expression": "Math.exp(x)"}  // e^x（JavaScript格式）
{"type": "expression", "expression": "pow(2,x)"}    // 2^x（传统格式）
{"type": "expression", "expression": "Math.pow(2,x)"}  // 2^x（JavaScript格式）
{"type": "expression", "expression": "pow(10,x)"}   // 10^x（传统格式）
{"type": "expression", "expression": "Math.pow(10,x)"}  // 10^x（JavaScript格式）

// 🟢 幂和根函数
{"type": "expression", "expression": "x*x"}         // x²平方（传统格式）
{"type": "expression", "expression": "Math.pow(x,2)"}  // x²平方（JavaScript格式）
{"type": "expression", "expression": "pow(x,3)"}    // x³立方（传统格式）
{"type": "expression", "expression": "Math.pow(x,3)"}  // x³立方（JavaScript格式）
{"type": "expression", "expression": "pow(x,4)"}    // x⁴四次方（传统格式）
{"type": "expression", "expression": "Math.pow(x,4)"}  // x⁴四次方（JavaScript格式）
{"type": "expression", "expression": "sqrt(x)"}     // √x 平方根（传统格式）
{"type": "expression", "expression": "Math.sqrt(x)"}  // √x 平方根（JavaScript格式）
{"type": "expression", "expression": "pow(x,1/3)"}  // ∛x 立方根（传统格式）
{"type": "expression", "expression": "Math.pow(x,1/3)"}  // ∛x 立方根（JavaScript格式）

// 🟢 其他数学函数
{"type": "expression", "expression": "1/x"}         // 倒数
{"type": "expression", "expression": "abs(x)"}      // 绝对值（传统格式）
{"type": "expression", "expression": "Math.abs(x)"}  // 绝对值（JavaScript格式）
{"type": "expression", "expression": "x!"}          // 阶乘（整数）
{"type": "expression", "expression": "Math.floor(x)"}  // 向下取整（JavaScript格式）
{"type": "expression", "expression": "Math.ceil(x)"}  // 向上取整（JavaScript格式）
{"type": "expression", "expression": "Math.round(x)"}  // 四舍五入（JavaScript格式）
...
{"type": "expression", "expression": "parseInt(x, 8)"}  // 八进制转十进制
{"type": "expression", "expression": "parseInt(x, 16)"}  // 十六进制转十进制
{"type": "expression", "expression": "x.toString(2)"}   // 十进制转二进制
{"type": "expression", "expression": "x.toString(8)"}   // 十进制转八进制
{"type": "expression", "expression": "x.toString(16)"}  // 十进制转十六进制
{"type": "expression", "expression": "Number(x).toString(2)"}  // 十进制转二进制（安全版）
{"type": "expression", "expression": "Number(x).toString(8)"}  // 十进制转八进制（安全版）
{"type": "expression", "expression": "Number(x).toString(16)"}  // 十进制转十六进制（安全版）

// 🚀 JavaScript位运算
{"type": "expression", "expression": "x & 0xFF"}       // 按位AND，取低8位
{"type": "expression", "expression": "x | 0"}          // 按位OR，转换为32位整数
{"type": "expression", "expression": "x ^ 0xFF"}       // 按位XOR，位翻转
{"type": "expression", "expression": "~x"}             // 按位NOT，位取反
{"type": "expression", "expression": "x << 1"}         // 左移1位（相当于乘以2）
{"type": "expression", "expression": "x >> 1"}         // 右移1位（相当于除以2）
{"type": "expression", "expression": "x >>> 1"}        // 无符号右移1位
{"type": "expression", "expression": "x << 2"}         // 左移2位（相当于乘以4）
{"type": "expression", "expression": "x >> 2"}         // 右移2位（相当于除以4）

// 🚀 JavaScript条件表达式
{"type": "expression", "expression": "x > 0 ? x : -x"}  // 三元运算符求绝对值
{"type": "expression", "expression": "x >= 0 ? 1 : -1"}  // 三元运算符求符号
{"type": "expression", "expression": "x % 2 === 0 ? 'even' : 'odd'"}  // 判断奇偶数
{"type": "expression", "expression": "x > 100 ? 'high' : x > 50 ? 'medium' : 'low'"}  // 多级条件

// 🚀 JavaScript逻辑运算
{"type": "expression", "expression": "x && y"}         // 逻辑AND
{"type": "expression", "expression": "x || y"}         // 逻辑OR
{"type": "expression", "expression": "!x"}             // 逻辑NOT
{"type": "expression", "expression": "x && x > 0"}     // 短路求值，检查正数
{"type": "expression", "expression": "x || 0"}         // 默认值设定
```
...
✅ Math.exp(x), Math.pow(x,y) - 指数函数
✅ Math.sqrt(x), Math.abs(x) - 平方根、绝对值
✅ Math.floor(x), Math.ceil(x), Math.round(x) - 取整函数
✅ Math.random() - 随机数生成
✅ Math.PI, Math.E - 数学常数

✅ **支持JavaScript数值处理**：
✅ parseInt(x, base) - 解析整数，支持进制
✅ parseFloat(x) - 解析浮点数
✅ Number(x) - 数值转换
✅ isNaN(x), isFinite(x) - 类型检查
✅ x.toString(base) - 数值转字符串，支持进制
...
✅ x === y, x !== y - 严格等于/不等于
✅ x == y, x != y - 等于/不等于
✅ x < y, x <= y, x > y, x >= y - 比较运算符

✅ **支持JavaScript自增自减**：
✅ x++, ++x - 自增
✅ x--, --x - 自减
✅ x += y, x -= y, x *= y, x /= y - 复合赋值

✅ **支持JavaScript进制转换**：
✅ Number(x).toString(2) - 十进制转二进制
✅ Number(x).toString(8) - 十进制转八进制
✅ Number(x).toString(16) - 十进制转十六进制
...
✅ **支持JavaScript Math对象**：
   - Math.sin(x), Math.cos(x), Math.tan(x) - 三角函数
   - Math.log(x), Math.log10(x), Math.exp(x) - 对数和指数函数
   - Math.sqrt(x), Math.abs(x), Math.pow(x, y) - 其他数学函数
   - Math.floor(x), Math.ceil(x), Math.round(x) - 取整函数
...
🚨 **不再修复JavaScript语法**：
所有JavaScript语法都被底层引擎支持，不需要转换为其他格式。
