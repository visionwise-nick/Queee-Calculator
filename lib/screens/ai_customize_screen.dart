...
class _AICustomizeScreenState extends State<AICustomizeScreen>
  ...
  void _showQuickReplies() {
    final quickReplies = [
      ...
      '对数指数计算器：在已有功能基础上，继续添加ln(自然对数)、log(常用对数)、e^x(指数)、10^x(10的幂)按键，完善科学计算能力',
      
      // 🔄 Level 4：进制转换功能 - 添加程序员常用功能
      '进制转换计算器：在已有功能基础上，新增二进制转换、八进制转换、十六进制转换按键，输入十进制数字一键转换其他进制',
      
      // 💰 Level 5：金融计算入门 - 添加基本金融功能
      '基础金融计算器：在已有功能基础上，增加复利计算(本金、利率、年数)和汇率转换(金额、汇率)按键，满足投资理财基本需求',
      
      // 🏠 Level 6：房贷专业计算 - 专业金融计算扩展
      '房贷计算器专业版：在已有功能基础上，添加一个计算房贷的功能，利率3.5%，贷款30年，输入贷款金额，一键计算每月等额本息还款额',
      
      // 📊 Level 7：统计分析功能 - 数据处理能力
      '统计分析计算器：在已有功能基础上，新增平均值、标准差、方差、最大值、最小值按键，支持多数字输入进行统计分析',
      
      // 🔀 Level 8：组合排列数学 - 高级数学功能
      '组合排列计算器：在已有功能基础上，添加组合C(n,r)、排列P(n,r)、阶乘n!按键，解决概率统计和数学问题',
      
      // 🏥 Level 9：生活实用工具 - 日常应用扩展
      '生活实用计算器：在已有功能基础上，增加BMI计算(身高、体重)、小费计算(账单、小费率)、折扣计算(原价、折扣率)按键',
      
      // 🌡️ Level 10：单位转换大全 - 全方位转换功能
      '单位转换计算器：在已有功能基础上，添加温度转换(摄氏度↔华氏度)、长度转换(厘米↔英寸)、重量转换(公斤↔磅)按键',
