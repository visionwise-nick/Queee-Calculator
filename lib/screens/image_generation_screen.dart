...
class _ImageGenerationScreenState extends State<ImageGenerationScreen>
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.opacity, color: Colors.blue.shade700),
                ),
                const SizedBox(width: 12),
                const Text(
                  'APP背景图透明度',
  ...
  void _applySingleButtonReset(CalculatorButton button) {
   ...
   /// 🔧 新增：按键背景透明度控制
   Widget _buildButtonBgOpacityControl() {
     return Container(
       padding: const EdgeInsets.all(12),
       decoration: BoxDecoration(
         color: Colors.orange.shade50,
             ...
             Row(
               children: [
                 Container(
                   ...
                   child: Icon(Icons.opacity, color: Colors.green.shade700),
                 ),
                 const SizedBox(width: 12),
                 const Text(
                   '显示区背景透明度',
             ...
             Column(
               ...
               children: [
                 Row(
                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                   children: [
                     Text('显示区背景透明度', style: TextStyle(color: Colors.grey.shade700)),
                     Container(
                       padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                       decoration: BoxDecoration(
                         color: Colors.green.shade100,
